    ...
    <ul>
        <li>
            <div id="content" class="content-container">
                ...
                <!-- 公告 -->
                <span id="announcement" class="content" style="display: none;"> 欢迎访问 Easy-QFNU！</span>
            </div>
        </li>
    </ul>
</div>
...
[Easy-QFNU](https://Easy-QFNU.top) 是免费、开源、共建、共享的公益项目，隶属于 [W1ndys](https://github.com/W1ndys) ，打破你的信息差，我们致力于整理实实在在影响校园生活的内容但是一般不被重视的东西，致力于让你的 QFNU 更简单~
...
| 链接                                                 | 描述                         |
| ---------------------------------------------------- | ---------------------------- |
| [Easy-选课](/Easy-SelectCourse/)                     | 帮助你快速了解选课           |
| [培养方案](/Easy-SelectCourse/Curriculum/)           | 各大专业的培养方案           |
| [选课指北](/Easy-SelectCourse/Selection-Guide/)      | wiki 形式的选课指南          |
| [选课推荐](/Easy-SelectCourse/Curriculum-Recommend/) | 帮助你快速找到适合自己的课程 |
...
- [: material-book-education: Easy-学院](/Easy-College/)
